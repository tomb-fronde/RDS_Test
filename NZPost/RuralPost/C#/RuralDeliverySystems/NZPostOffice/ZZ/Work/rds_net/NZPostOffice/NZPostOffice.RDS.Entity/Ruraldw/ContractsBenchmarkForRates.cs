...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    public class ContractsBenchmarkForRates : Entity<ContractsBenchmarkForRates>
    {
        ...
        public static ContractsBenchmarkForRates[] GetAllContractsBenchmarkForRates(int? al_rg_code)
        {
...
/* TJB RPCR_134 July-2019: disabled  + "   AND c.con_base_cont_type = 1 "  */
                    ...
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            ...
                            instance._override_ruc_rate = GetValueFromReader<Int32?>(dr, 6);
                            instance._original_ruc_rate = GetValueFromReader<Decimal?>(dr, 7);
                            instance._bench_mark = GetValueFromReader<Int32?>(dr, 8);
