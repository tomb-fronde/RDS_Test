...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class PsNonumberTownDataSet : ReportDataSet<PsNonumberTown>
    {
        ...
        public PsNonumberTownDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<PsNonumberTown> datas = dataSource as Metex.Core.EntityBindingList<PsNonumberTown>;
        ...
        protected override DataRow ApplyRow(PsNonumberTown data)
        {
