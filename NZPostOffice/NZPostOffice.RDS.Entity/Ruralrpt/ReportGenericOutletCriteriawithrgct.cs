...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class ReportGenericOutletCriteriawithrgct : Entity<ReportGenericOutletCriteriawithrgct>
	{
		...
		public static ReportGenericOutletCriteriawithrgct NewReportGenericOutletCriteriawithrgct(  )
		{
			return Create();
		}

		public static ReportGenericOutletCriteriawithrgct[] GetAllReportGenericOutletCriteriawithrgct(  )
		{
			return Fetch().list;
		}
		#endregion
		...
		private void FetchEntity(  )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<ReportGenericOutletCriteriawithrgct> _list = new List<ReportGenericOutletCriteriawithrgct>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							ReportGenericOutletCriteriawithrgct instance = new ReportGenericOutletCriteriawithrgct();
