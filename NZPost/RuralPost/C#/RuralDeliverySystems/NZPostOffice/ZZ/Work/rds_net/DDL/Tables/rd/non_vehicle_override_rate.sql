/****** Object:  Table [rd].[non_vehicle_override_rate]    Script Date: 08/05/2008 15:01:47 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [rd].[non_vehicle_override_rate](
	...
	[nvor_frozen] [varchar](1) COLLATE Latin1_General_CI_AS NULL,
 ...
 CONSTRAINT [non_vehicle_override_rate_cns] PRIMARY KEY CLUSTERED 
(
	[contract_no] ASC,
