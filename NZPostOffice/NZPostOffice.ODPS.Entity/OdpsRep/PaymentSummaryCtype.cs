...
namespace NZPostOffice.ODPS.Entity.OdpsRep
{
	...
	public class PaymentSummaryCtype : Entity<PaymentSummaryCtype>
	{
		...
		public static PaymentSummaryCtype NewPaymentSummaryCtype( DateTime? sdate, DateTime? edate, int? inregion, string inctype )
		{
			return Create(sdate, edate, inregion, inctype);
		}

		public static PaymentSummaryCtype[] GetAllPaymentSummaryCtype( DateTime? sdate, DateTime? edate, int? inregion, string inctype )
		{
			return Fetch(sdate, edate, inregion, inctype).list;
		}
		#endregion

		#region Data Access
		[ServerMethod]
		private void FetchEntity( DateTime? sdate, DateTime? edate, int? inregion, string inctype )
		{
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
                    ...
                    cm.CommandText = "odps.od_rps_pay_summary_ctype";
					ParameterCollection pList = new ParameterCollection();
					pList.Add(cm, "sdate", sdate);
					pList.Add(cm, "edate", edate);
					pList.Add(cm, "inregion", inregion);
					pList.Add(cm, "inctype", inctype);

					List<PaymentSummaryCtype> _list = new List<PaymentSummaryCtype>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							PaymentSummaryCtype instance = new PaymentSummaryCtype();
