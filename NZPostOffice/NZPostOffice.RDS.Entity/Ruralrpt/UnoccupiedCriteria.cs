...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class UnoccupiedCriteria : Entity<UnoccupiedCriteria>
	{
		...
		public static UnoccupiedCriteria NewUnoccupiedCriteria(  )
		{
			return Create();
		}

		public static UnoccupiedCriteria[] GetAllUnoccupiedCriteria(  )
		{
			return Fetch().list;
		}
		#endregion
		...
		private void FetchEntity(  )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<UnoccupiedCriteria> _list = new List<UnoccupiedCriteria>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							UnoccupiedCriteria instance = new UnoccupiedCriteria();
