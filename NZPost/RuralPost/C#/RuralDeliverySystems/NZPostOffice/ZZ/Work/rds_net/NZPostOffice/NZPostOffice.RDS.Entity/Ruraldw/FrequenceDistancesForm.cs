...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
	...
	public class FrequenceDistancesForm : Entity<FrequenceDistancesForm>
	{
		...
		public static FrequenceDistancesForm NewFrequenceDistancesForm( int? inContract, int? inSFKey, string inDeliveryDays )
		{
			return Create(inContract, inSFKey, inDeliveryDays);
		}

		public static FrequenceDistancesForm[] GetAllFrequenceDistancesForm( int? inContract, int? inSFKey, string inDeliveryDays )
		{
		...
		private void FetchEntity( int? inContract, int? inSFKey, string inDeliveryDays )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<FrequenceDistancesForm> _list = new List<FrequenceDistancesForm>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							FrequenceDistancesForm instance = new FrequenceDistancesForm();
                            ...
                            instance._fd_no_of_boxes = GetValueFromReader<Int16?>(dr,5);
                            instance._fd_no_rural_bags = GetValueFromReader<Int16?>(dr,6);
                            instance._fd_no_other_bags = GetValueFromReader<Int16?>(dr,7);
                            instance._fd_no_private_bags = GetValueFromReader<Int16?>(dr,8);
                            instance._fd_no_post_offices = GetValueFromReader<Int16?>(dr,9);
                            instance._fd_no_cmbs = GetValueFromReader<Int16?>(dr,10);
                            instance._fd_no_cmb_customers = GetValueFromReader<Int16?>(dr,11);
                            instance._fd_volume = GetValueFromReader<Decimal?>(dr,12);
