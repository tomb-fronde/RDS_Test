    ...
    public class NCstObjectMsg
        {
            ...
            //?public Dictionary<int, ostr_msgsrvc> istr_msgsrvc = new Dictionary<int, ostr_msgsrvc>();
          
            public ostr_msgsrvc[] istr_msgsrvc = new ostr_msgsrvc[1000];

            public int of_removeallforobject(string asv_object)
            {
            ...
            public int of_addmsg(string asv_object, string asv_msg, object aanyv_value)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method:			of_AddMsg
            ...
            public bool of_getmsg(string asv_object, string asv_msg, ref object aanyr_value)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method:			of_GetMsg
                // 	Description:	this function is OVERLOADED,
            ...
            public int of_addmsg(string asv_object, string asv_msg, object aanyv_value, string asv_remove)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method: 		of_AddMsg
                //  Description:	this function is OVERLOADED,
            ...
            public bool of_getmsg(string asv_object, string asv_msg, ref object aanyr_value, string asv_remove)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method:			of_GetMsg
                ...
                aanyr_value = null;   //aanyr_value = lany_null;

                return false;
            }

            public int of_addarraymsg(string asv_object, string asv_msg, object[] aanyv_value)
            {
            ...
            public int of_addarraymsg(string asv_object, string asv_msg, object[] aanyv_value, double adblv_session)
            {
                //  Object:			cs_n_ObjectMsg
                //  Method: 		of_AddArrayMsg
                //  Description:	this function is OVERLOADED,
            ...
            public int of_addarraymsg(string asv_object, string asv_msg, object[] aanyv_value, string asv_remove)
            {
                //  Object:			cs_n_ObjectMsg
                //  Method: 		of_AddArrayMsg
                //  Description:	this function is OVERLOADED,
            ...
            public int of_addarraymsg(string asv_object, string asv_msg, object[] aanyv_value, string asv_remove, double adblv_session)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method: 		of_AddMsg
            ...
            public int of_addmsg(string asv_object, string asv_msg, object aanyv_value, double adblv_session)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method:			of_AddMsg
            ...
            public int of_addmsg(string asv_object, string asv_msg, object aanyv_value, string asv_remove, double adblv_session)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method: 		of_AddMsg
                //  Description:	place a new message for the specified object onto the queue
            ...
            public bool of_getarraymsg(string asv_object, string asv_msg, ref object[] aanyr_value, string asv_remove)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method:			of_GetMsg
            ...
            public int of_removesession(double adblv_session)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
            ...
            public bool of_getarraymsg(string asv_object, string asv_msg, ref object[] aanyr_value)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method:			of_GetMsg
            ...
            public bool of_getmsgpickedup(string asv_object, string asv_msg)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
            ...
            public int of_cleararray(int aiv_index)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
            ...
            public int of_clearmsg(int aiv_index)
            {
                //  Object:			cs_n_ObjectMsg_Srvc
                //  Method:			of_ClearMsg
