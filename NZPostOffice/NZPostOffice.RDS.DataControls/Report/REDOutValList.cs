...
namespace NZPostOffice.RDS.DataControls.Report {
    ...
    public class REDOutValList : ReportClass {
        
        public REDOutValList() {
        }
        
        public override string ResourceName {
            get {
                return "REDOutValList.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "NZPostOffice.RDS.DataControls.Report.REDOutValList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedREDOutValList : Component, ICachedReport {
        
        public CachedREDOutValList() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            REDOutValList rpt = new REDOutValList();
            rpt.Site = this.Site;
            return rpt;
        }
