...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class PsRoadnameConDataSet : ReportDataSet<PsRoadnameCon>
    {
        ...
        public PsRoadnameConDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<PsRoadnameCon> datas = dataSource as Metex.Core.EntityBindingList<PsRoadnameCon>;
        ...
        protected override DataRow ApplyRow(PsRoadnameCon data)
        {
