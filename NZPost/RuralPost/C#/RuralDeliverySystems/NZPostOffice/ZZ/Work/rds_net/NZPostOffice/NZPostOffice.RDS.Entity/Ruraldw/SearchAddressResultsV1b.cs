...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    public class SearchAddressResultsV1b : Entity<SearchAddressResultsV1b>
    {
        ...
        public static SearchAddressResultsV1b NewSearchAddressResultsV1b(string in_AdrNum, string in_roadName, int? in_roadType, int? in_roadSuffix, int? in_SuburbId, int? in_TownId, int? in_Contract, string in_RDNo, string in_Surname, string in_Initials, string in_UI_UserId, int? in_ComponentId, int? in_rd_contract, int? in_dpid)
        {
            return Create(in_AdrNum, in_roadName, in_roadType, in_roadSuffix, in_SuburbId, in_TownId, in_Contract, in_RDNo, in_Surname, in_Initials, in_UI_UserId, in_ComponentId, in_rd_contract, in_dpid);
        }

        public static SearchAddressResultsV1b[] GetAllSearchAddressResultsV1b(string in_AdrNum, string in_roadName, int? in_roadType, int? in_roadSuffix, int? in_SuburbId, int? in_TownId, int? in_Contract, string in_RDNo, string in_Surname, string in_Initials, string in_UI_UserId, int? in_ComponentId, int? in_rd_contract, int? in_dpid)
        {
            return Fetch(in_AdrNum, in_roadName, in_roadType, in_roadSuffix, in_SuburbId, in_TownId, in_Contract, in_RDNo, in_Surname, in_Initials, in_UI_UserId, in_ComponentId, in_rd_contract, in_dpid).list;
        }
        #endregion

        #region Data Access
        [ServerMethod]
        private void FetchEntity(string in_AdrNum, string in_roadName, int? in_roadType, int? in_roadSuffix, int? in_SuburbId, int? in_TownId, int? in_Contract, string in_RDNo, string in_Surname, string in_Initials, string in_UI_UserId, int? in_ComponentId, int? in_rd_contract, int? in_dpid)
        {
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
            {
                using (DbCommand cm = cn.CreateCommand())
                {
                    ...
                    cm.CommandText = "rd.sp_searchforaddress_v2";
                    List<SearchAddressResultsV1b> _list = new List<SearchAddressResultsV1b>();
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            SearchAddressResultsV1b instance = new SearchAddressResultsV1b();
