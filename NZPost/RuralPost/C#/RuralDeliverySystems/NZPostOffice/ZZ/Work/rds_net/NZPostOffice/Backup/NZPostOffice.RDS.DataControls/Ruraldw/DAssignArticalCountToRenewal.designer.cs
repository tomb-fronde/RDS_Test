...
{
	partial class DAssignArticalCountToRenewal
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDS.Entity.Ruraldw.AssignArticalCountToRenewal);
            ...
            this.compute_1.HeaderText = "Select Renewal";
            this.compute_1.Name = "compute_1";
            this.compute_1.Width = 100;
