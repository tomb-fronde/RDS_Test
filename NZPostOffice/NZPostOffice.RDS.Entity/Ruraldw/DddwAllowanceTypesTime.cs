...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    // Get only Time-based allowance calc Allowance_types
	...
	public class DddwAllowanceTypesTime : Entity<DddwAllowanceTypesTime>
	{
		...
		public static DddwAllowanceTypesTime NewDddwAllowanceTypesTime(  )
		{
			return Create();
		}

		public static DddwAllowanceTypesTime[] GetAllDddwAllowanceTypesTime()
		{
			return Fetch().list;
		}
		#endregion
			...
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
                try
                {
                    using (DbCommand cm = cn.CreateCommand())
                    {
                        ...
                        List<DddwAllowanceTypesTime> _list = new List<DddwAllowanceTypesTime>();
                        using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                        {
                            while (dr.Read())
                            {
                                DddwAllowanceTypesTime instance = new DddwAllowanceTypesTime();
