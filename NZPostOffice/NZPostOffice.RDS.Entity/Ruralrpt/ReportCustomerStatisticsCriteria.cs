...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class ReportCustomerStatisticsCriteria : Entity<ReportCustomerStatisticsCriteria>
	{
		...
		public static ReportCustomerStatisticsCriteria NewReportCustomerStatisticsCriteria(  )
		{
			return Create();
		}

		public static ReportCustomerStatisticsCriteria[] GetAllReportCustomerStatisticsCriteria(  )
		{
			return Fetch().list;
		}
		#endregion
		...
		private void FetchEntity(  )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<ReportCustomerStatisticsCriteria> _list = new List<ReportCustomerStatisticsCriteria>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							ReportCustomerStatisticsCriteria instance = new ReportCustomerStatisticsCriteria();
