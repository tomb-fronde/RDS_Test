...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class PsCustListConDataSet : ReportDataSet<PsCustListCon>
    {
        ...
        public PsCustListConDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<PsCustListCon> datas = dataSource as Metex.Core.EntityBindingList<PsCustListCon>;
        ...
        protected override DataRow ApplyRow(PsCustListCon data)
        {
