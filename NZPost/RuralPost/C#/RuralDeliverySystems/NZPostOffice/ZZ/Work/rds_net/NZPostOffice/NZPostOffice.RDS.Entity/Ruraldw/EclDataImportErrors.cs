...
/*
    ...
    [MapInfoIndex(new string[] { "ecl_customer_code", "ecl_seq",            "ecl_ticket_no",     "ecl_ticket_part",
                                 "ecl_driver_id",     "ecl_rate_code",      "ecl_rate_descr",    "ecl_pkg_descr",   
                                 "ecl_batch_id",      "ecl_run_id",         "ecl_run_no",        "ecl_driver_date", 
                                 "ecl_date_entered",  "ecl_ticket_payable", "ecl_rural_payable", "ecl_scan_count",  
                                 "ecl_sig_req_flag",  "ecl_sig_captured",   "ecl_sig_name",      "ecl_pr_code" })]
    [System.Serializable()]
*/
    public class EclDataImportError : Entity<EclDataImportError>
    {
		...
		{
			return string.Format( "{0}/{1}", _ecl_ticket_no, _ecl_ticket_part );
		}

        #endregion

        #region Factory Methods
        public static EclDataImportError NewEclDataImportError(  )
        {
            return Create();
        }

        public static EclDataImportError[] GetAllEclDataImportError(  )
        {
            return Fetch().list;
        }     
...
*/
        #endregion
        [ServerMethod()]
        private void CreateEntity(string ecl_ticket_no, string ecl_ticket_part)
        {
