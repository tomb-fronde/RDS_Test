...
CREATE procedure [odps].[OD_RPS_Invoice_pay_piecerate_detailxp](
	@invoiceid int,
	@contractno int,
	@contractorno int,
...
BEGIN
  ...
  begin
      ...
      select t_invoice_piecerates3.invoice_id,
             ...
             t_invoice_piecerates3.cost,
             t_invoice_piecerates3.atype 
        from t_invoice_piecerates3 
       where t_invoice_piecerates3.invoice_id = @invoiceid and
             t_invoice_piecerates3.prd_date between @v_contractor_start 
                                                and @v_contractor_end 
       order by t_invoice_piecerates3.prd_date asc,
      ...
      select t_invoice_piecerates3.invoice_id,
             ...
             t_invoice_piecerates3.atype 
        from t_invoice_piecerates3 
       where t_invoice_piecerates3.invoice_id = @invoiceid 
       order by t_invoice_piecerates3.prd_date asc,
                t_invoice_piecerates3.prt_code asc
end