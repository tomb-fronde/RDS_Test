...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class SummaryCustListSeq : Entity<SummaryCustListSeq>
	{
		...
		public static SummaryCustListSeq NewSummaryCustListSeq( int? in_contract_no, int? in_sf_key, string in_rd_del_days, string in_sortorder )
		{
			return Create(in_contract_no, in_sf_key, in_rd_del_days, in_sortorder);
		}

		public static SummaryCustListSeq[] GetAllSummaryCustListSeq( int? in_contract_no, int? in_sf_key, string in_rd_del_days, string in_sortorder )
		{
		...
		private void FetchEntity( int? in_contract_no, int? in_sf_key, string in_rd_del_days, string in_sortorder )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
                    ...
                    cm.CommandText = "rd.sp_summary_cust_list_seq";
					...
					List<SummaryCustListSeq> _list = new List<SummaryCustListSeq>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							SummaryCustListSeq instance = new SummaryCustListSeq();
