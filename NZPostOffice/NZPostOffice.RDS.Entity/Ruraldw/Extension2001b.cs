...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    [MapInfo("hourly_wage", "_hourly_wage", "")]
    ...
    public class Extension2001b : Entity<Extension2001b>
    {
        ...
        public virtual decimal? HourlyWage
        {
            get
            {
                CanReadProperty("HourlyWage", true);
                return _hourly_wage;
            }
            set
            {
                CanWriteProperty("HourlyWage", true);
                if (_hourly_wage != value)
                {
                    _hourly_wage = value;
                    PropertyHasChanged();
                }
        ...
        public virtual decimal? VolumeCustomer
        {
            get
            {
                ...
                //if(isnull(mail_volume),0,mail_volume)  / (if(isnull(boxes),0,boxes) + if(isnull(no_cmb_customers),0,no_cmb_customers))
                return (_mail_volume == null ? 0 : _mail_volume) / ((_boxes == null ? 0 : _boxes) + (_no_cmb_customers == null ? 0 : _no_cmb_customers));
            }
        }
        ...
        public virtual decimal? ProcHrsChange
        {
            get
            {
                ...
                return ((CustChange * VolumeCustomer) / _rr_item_proc_rate_per_hr / ((decimal?)52.1429));
            }
        }
        ...
        public virtual decimal? L2
        {
            get
            {
                ...
                return (CustChange == null ? 0 : CustChange) * (25 / 60);
            }
        }
        ...
        public virtual decimal? DelDaysPerWeek
        {
            get
            {
                ...
                return ((L3 * (_no_del_days_year / 50)) / 60);
            }
        }
        ...
        public virtual decimal? Tyretubecost
        {
            get
            {
                ...
                return (_extn_distance * _no_del_days_year) * (_typestube / 1000);
            }
        }
        ...
        public virtual decimal? Fuelcost
        {
            get
            {
                ...
                return (_consumptionrate / 100) * (_extn_distance * _no_del_days_year) * (_fuelrate / 100);
            }
        }
        ...
        public virtual decimal? Repmaintcost
        {
            get
            {
                ...
                return (_extn_distance * _no_del_days_year) * (_repairsmaint / 1000);
            }
        }
        ...
        public virtual decimal? Vehicledep
        {
            get
            {
                ...
                return (_ndepreciation2 > 0 ? _ndepreciation2 : (_extn_distance * _no_del_days_year) * (_vehicalallow / 1000));
            }
        }
        ...
        //(((( volume_change  /  rr_item_proc_rate_per_hr ) / 365) * 7) * 56) *  hourly_wage
        public virtual decimal? Proccost
        {
            get
            {
                CanReadProperty("Proccost", true);
                return ((((VolumeChange / _rr_item_proc_rate_per_hr) / 365) * 7) * 56) * _hourly_wage;
            }
        }

        // needs to implement compute expression manually:
        // compute control name=[delcost]
        //extn_del_hrs  * 56 *  hourly_wage
        public virtual decimal? Delcost
        {
            get
            {
                CanReadProperty("Delcost", true);
                return _extn_del_hrs * 56 * _hourly_wage;
            }
        }
        ...
        public virtual decimal? Extnamnt1
        {
            get
            {
                ...
                return (((Ruccost == null ? 0 : Ruccost) + (Acccost == null ? 0 : Acccost) + (Proccost == null ? 0 : Proccost) + (Delcost == null ? 0 : Delcost) + (Tyretubecost == null ? 0 : Tyretubecost) + (Repmaintcost == null ? 0 : Repmaintcost) + (Fuelcost == null ? 0 : Fuelcost) + (Vehicledep == null ? 0 : Vehicledep)) > 0 ? Math.Round(((Ruccost == null ? 0 : Ruccost) + (Acccost == null ? 0 : Acccost) + (Proccost == null ? 0 : Proccost) + (Delcost == null ? 0 : Delcost) + (Tyretubecost == null ? 0 : Tyretubecost) + (Repmaintcost == null ? 0 : Repmaintcost) + (Fuelcost == null ? 0 : Fuelcost) + (Vehicledep == null ? 0 : Vehicledep) + ((decimal?)0.5)).GetValueOrDefault(), 0) : Math.Round(((Ruccost == null ? 0 : Ruccost) + (Acccost == null ? 0 : Acccost) + (Proccost == null ? 0 : Proccost) + (Delcost == null ? 0 : Delcost) + (Tyretubecost == null ? 0 : Tyretubecost) + (Repmaintcost == null ? 0 : Repmaintcost) + (Fuelcost == null ? 0 : Fuelcost) + (Vehicledep == null ? 0 : Vehicledep)).GetValueOrDefault(), 0));
            }
        }

        // needs to implement compute expression manually:
        // compute control name=[acccost]
        //accrate /100) * ( delcost  +  proccost 
        public virtual decimal? Acccost
        {
            get
            {
                CanReadProperty("Acccost", true);
                return (_accrate / 100) * (Delcost + Proccost);
            }
        }

        // needs to implement compute expression manually:
        // compute control name=[compute_3]
        //proccost  +  delcost  +  acccost
        public virtual decimal? Compute3
        {
            get
            {
                CanReadProperty("Compute3", true);
                return Proccost + Delcost + Acccost;
            }
        }
        ...
        public virtual decimal? Ruccost
        {
            get
            {
                ...
                return (((_extn_distance == null ? 0 : _extn_distance) * (_no_del_days_year == null ? 0 : _no_del_days_year)) * ((_nruc == null ? 0 : _nruc) / 1000)) * _nuse_rucs;
            }
        }
        ...
        //ceiling(	if(isNull(ruccost),0,ruccost)+ 		if(isNull(acccost ),0,acccost) +  		if(isNull(proccost ),0,proccost ) +  		if(isNull(delcost),0,delcost )  +  		if(isnull(tyretubecost),0,tyretubecost)  +  		if(isNull(repmaintcost),0,repmaintcost)  +  		if(isNull(fuelcost),0,fuelcost)  +  		if(isNull(vehicledep),0,vehicledep) )
        public virtual decimal? Extnamnt
        {
            get
            {
                CanReadProperty("Extnamnt", true);
                return Math.Ceiling(((Ruccost == null ? 0 : Ruccost) + (Acccost == null ? 0 : Acccost) + (Proccost == null ? 0 : Proccost) + (Delcost == null ? 0 : Delcost) + (Tyretubecost == null ? 0 : Tyretubecost) + (Repmaintcost == null ? 0 : Repmaintcost) + (Fuelcost == null ? 0 : Fuelcost) + (Vehicledep == null ? 0 : Vehicledep)).GetValueOrDefault());
            }
        }
        ...
        public static Extension2001b NewExtension2001b(int? in_contract)
        {
            return Create(in_contract);
        }

        public static Extension2001b[] GetAllExtension2001b(int? in_contract)
        {
        ...
        private void FetchEntity(int? in_contract)
        {
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
            {
                using (DbCommand cm = cn.CreateCommand())
                {
                    ...
                    cm.CommandText = "rd.sp_getextndata2001b";

                    List<Extension2001b> _list = new List<Extension2001b>();
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            Extension2001b instance = new Extension2001b();
                            ...
                            instance._boxes = GetValueFromReader<Int16?>(dr,4);
                            instance._rural_bags = GetValueFromReader<Int16?>(dr,5);
                            instance._other_bags = GetValueFromReader<Int16?>(dr,6);
                            instance._private_bags = GetValueFromReader<Int16?>(dr,7);
                            instance._post_offices = GetValueFromReader<Int16?>(dr,8);
                            instance._no_cmbs = GetValueFromReader<Int16?>(dr,9);
                            instance._no_cmb_customers = GetValueFromReader<Int16?>(dr,10);
                            instance._del_hrs = GetValueFromReader<Decimal?>(dr,11);
                            instance._proc_hrs = GetValueFromReader<Decimal?>(dr,12);
                            instance._mail_volume = GetValueFromReader<Int32?>(dr,13);
                            ...
                            instance._extn_reason = GetValueFromReader<String>(dr,26);
                            instance._no_del_days_year = GetValueFromReader<Int32?>(dr,27);
                            instance._hourly_wage = GetValueFromReader<Decimal?>(dr,28);
