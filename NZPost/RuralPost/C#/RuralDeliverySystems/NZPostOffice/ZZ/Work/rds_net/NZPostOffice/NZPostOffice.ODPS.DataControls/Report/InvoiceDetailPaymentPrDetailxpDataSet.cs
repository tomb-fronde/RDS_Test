...
namespace NZPostOffice.ODPS.DataControls.Report
{
    ...
    public class InvoiceDetailPaymentPrDetailxpDataSet : ReportDataSet<InvoiceDetailPaymentPrDetailxp>
    {
        ...
        public InvoiceDetailPaymentPrDetailxpDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<InvoiceDetailPaymentPrDetailxp> datas = dataSource as Metex.Core.EntityBindingList<InvoiceDetailPaymentPrDetailxp>;
        ...
        protected override DataRow ApplyRow(InvoiceDetailPaymentPrDetailxp data)
        {
