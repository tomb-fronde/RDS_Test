...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class VehicleExpCriteria : Entity<VehicleExpCriteria>
	{
		...
		public static VehicleExpCriteria NewVehicleExpCriteria(  )
		{
			return Create();
		}

		public static VehicleExpCriteria[] GetAllVehicleExpCriteria(  )
		{
			return Fetch().list;
		}
		#endregion
			...
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
                    ...
                    cm.CommandText = " SELECT  outlet.region_id ,"
                        ...
                        + " 0 rg_code1,"
                        + " 0 rg_code2,"
                        + " CAST(FLOOR( CAST( GETDATE() AS FLOAT ) ) AS DATETIME) mail_count_date,"
                        + " 0 blankforms"
                        + " FROM outlet ,"
                        + " contract_type ,"
                        + " renewal_group ,"
					...
					List<VehicleExpCriteria> _list = new List<VehicleExpCriteria>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							VehicleExpCriteria instance = new VehicleExpCriteria();
