...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    public class ContractArticalCounts : Entity<ContractArticalCounts>
    {
        ...
        public static ContractArticalCounts NewContractArticalCounts(int? in_Contract)
        {
            return Create(in_Contract);
        }

        public static ContractArticalCounts[] GetAllContractArticalCounts(int? in_Contract)
        {
        ...
        private void FetchEntity(int? in_Contract)
        {
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
            {
                using (DbCommand cm = cn.CreateCommand())
                {
                    ...
                    List<ContractArticalCounts> _list = new List<ContractArticalCounts>();
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            ContractArticalCounts instance = new ContractArticalCounts();
