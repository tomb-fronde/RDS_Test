...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class OwnerDriverReportCriteria : Entity<OwnerDriverReportCriteria>
	{
		...
		[DBField()]
        private string _ownerdriver = "<All Outlets>";
		...
		public static OwnerDriverReportCriteria NewOwnerDriverReportCriteria(  )
		{
			return Create();
		}

		public static OwnerDriverReportCriteria[] GetAllOwnerDriverReportCriteria(  )
		{
			return Fetch().list;
		}
		#endregion
		...
		private void FetchEntity(  )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<OwnerDriverReportCriteria> _list = new List<OwnerDriverReportCriteria>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							OwnerDriverReportCriteria instance = new OwnerDriverReportCriteria();
