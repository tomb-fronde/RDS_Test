namespace NZPostOffice.RDS.DataControls.Ruralsec
{
	partial class DUserGroups
	{
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDS.Entity.Ruralsec.UserGroups);
			...
			this.group_id.HeaderText = "Rds User\r\nId GroupUg Id";
			...
			this.group_name.HeaderText = "Rds User Group\r\nUg Name";
			...
			this.group_description.HeaderText = "Rds User Group\r\nUg Description";
			...
			this.created_date.HeaderText = "Rds User\r\nGroupUg Created Date";
			...
			this.created_by.HeaderText = "Rds User\r\n GroupUg Created By";
			...
			this.modified_by.HeaderText = "Rds User\r\nGroupUg Modified By";
			...
			this.privacy_override.HeaderText = "Rds User\r\n GroupUg Privacy Override";
