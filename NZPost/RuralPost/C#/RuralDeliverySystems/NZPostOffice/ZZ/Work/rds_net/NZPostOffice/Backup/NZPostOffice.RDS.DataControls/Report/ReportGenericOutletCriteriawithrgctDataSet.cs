...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class RReportGenericOutletCriteriawithrgct
    {
        public int RegionId
        {
            get
    ...
    public class ReportGenericOutletCriteriawithrgctDataSet : ReportDataSet<ReportGenericOutletCriteriawithrgct>
    {
        ...
        public ReportGenericOutletCriteriawithrgctDataSet()
        {
        ...
        public ReportGenericOutletCriteriawithrgctDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<ReportGenericOutletCriteriawithrgct> datas = dataSource as Metex.Core.EntityBindingList<ReportGenericOutletCriteriawithrgct>;
        ...
        protected override DataRow ApplyRow(ReportGenericOutletCriteriawithrgct data)
        {
