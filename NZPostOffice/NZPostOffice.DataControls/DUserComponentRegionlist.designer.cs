...
{
	partial class DUserComponentRegionlist
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.Entity.UserComponentRegionlist);
			...
			this.region_id.HeaderText = "Rds User Rights Region Id";
			this.region_id.Name = "region_id";
			this.region_id.ReadOnly = true;
			this.region_id.Width = 167;
