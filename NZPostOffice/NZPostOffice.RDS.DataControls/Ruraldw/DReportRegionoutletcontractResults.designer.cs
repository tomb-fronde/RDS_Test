...
{
	partial class DReportRegionoutletcontractResults
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDS.Entity.Ruraldw.ReportRegionoutletcontractResults);
			...
			this.con_title.HeaderText = "Contracts Found";
