namespace NZPostOffice.RDS.DataControls.Ruralsec
{
	partial class DGroupDetails
	{
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDS.Entity.Ruralsec.GroupDetails);
			...
			this.privacy_override.Width =116;
