...
namespace NZPostOffice.ODPS.Entity.OdpsRep
{
	...
	public class ApInterfaceDetailRows : Entity<ApInterfaceDetailRows>
	{
		...
		public static ApInterfaceDetailRows NewApInterfaceDetailRows( DateTime? ProcDate )
		{
			return Create(ProcDate);
		}

		public static ApInterfaceDetailRows[] GetAllApInterfaceDetailRows( DateTime? ProcDate )
		{
		...
		private void FetchEntity( DateTime? ProcDate )
		{
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
                    ...
                    cm.CommandText = "odps.od_rps_ap_interface_footer_consolidated";
					ParameterCollection pList = new ParameterCollection();
					pList.Add(cm, "ProcDate", ProcDate);

					List<ApInterfaceDetailRows> _list = new List<ApInterfaceDetailRows>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							ApInterfaceDetailRows instance = new ApInterfaceDetailRows();
                            setValue(instance,dr);
							instance.MarkOld();
        ...
        private void setValue(ApInterfaceDetailRows instance,MDbDataReader dr)
        {
