...
namespace NZPostOffice.ODPS.DataControls.Report
{
    ...
    public class RInvoiceDetailPaymentPrDetailcp
    {
    ...
    public class InvoiceDetailPaymentPrDetailcpDataSet : ReportDataSet<InvoiceDetailPaymentPrDetailcp>
    {
        ...
        public InvoiceDetailPaymentPrDetailcpDataSet()
        {
        ...
        public InvoiceDetailPaymentPrDetailcpDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<InvoiceDetailPaymentPrDetailcp> datas = dataSource as Metex.Core.EntityBindingList<InvoiceDetailPaymentPrDetailcp>;
        ...
        protected override DataRow ApplyRow(InvoiceDetailPaymentPrDetailcp data)
        {
