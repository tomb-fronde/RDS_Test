...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
	...
	public class VehicalTypesList : Entity<VehicalTypesList>
	{
		...
		public static VehicalTypesList NewVehicalTypesList(  )
		{
			return Create();
		}

		public static VehicalTypesList[] GetAllVehicalTypesList(  )
		{
			return Fetch().list;
		}
		#endregion
		...
		private void FetchEntity(  )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<VehicalTypesList> _list = new List<VehicalTypesList>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							VehicalTypesList instance = new VehicalTypesList();
