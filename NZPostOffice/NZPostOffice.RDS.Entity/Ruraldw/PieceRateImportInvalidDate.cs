...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    [MapInfoIndex(new string[] { "contract", "prd_date", "prt_code", "prd_quantity", "prd_cost", "contract_no", "prt_key", "prd_rd_cost", "totalcost" })]
    [System.Serializable()]

    public class PieceRateImportInvalidDate : Entity<PieceRateImportInvalidDate>
    {
        ...
        //?round(prd_quantity  *  prd_rd_cost,2)
        ...
        public virtual decimal? Totalcost
        {
            get
            {
                ...
                _totalcost = Math.Round((_prd_quantity * _prd_rd_cost).GetValueOrDefault(), 2);
                return _totalcost;
            }
        }
        ...
        public static PieceRateImportInvalidDate NewPieceRateImportInvalidDate()
        {
            return Create();
        }

        public static PieceRateImportInvalidDate[] GetAllPieceRateImportInvalidDate()
        {
            return Fetch().list;
        }
        #endregion
        ...
        //            List<PieceRateImportInvalidDate> _list = new List<PieceRateImportInvalidDate>();
        //            using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
        //            {
        //                while (dr.Read())
        //                {
        //                    PieceRateImportInvalidDate instance = new PieceRateImportInvalidDate();
        //                    instance.MarkOld();
        //                    _list.Add(instance);
        //                }
        //                list = _list.ToArray();
