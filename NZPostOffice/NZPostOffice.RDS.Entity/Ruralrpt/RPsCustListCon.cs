...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class PsCustListCon : Entity<PsCustListCon>
	{
		...
		public static PsCustListCon NewPsCustListCon( int? con_id )
		{
			return Create(con_id);
		}

		public static PsCustListCon[] GetAllPsCustListCon( int? con_id )
		{
		...
		private void FetchEntity( int? con_id )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
                    ...
                    cm.CommandText = "rd.sp_cust_list_con";
					List<PsCustListCon> _list = new List<PsCustListCon>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							PsCustListCon instance = new PsCustListCon();
