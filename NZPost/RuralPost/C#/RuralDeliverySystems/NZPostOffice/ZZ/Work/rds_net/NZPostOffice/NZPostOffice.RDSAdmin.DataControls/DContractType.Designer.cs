namespace NZPostOffice.RDSAdmin.DataControls.Security
{
	partial class DContractType
	{
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDSAdmin.Entity.Security.ContractTypeBE);
        ...
        private void bindingSource_ListChanged(object sender, System.ComponentModel.ListChangedEventArgs args)
        {
            ...
            {
                if (((NZPostOffice.RDSAdmin.Entity.Security.ContractTypeBE)this.bindingSource.List[args.NewIndex]).IsNew)
                {
