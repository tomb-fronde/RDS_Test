...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class RPieceRateImportDiffRateReport
    {
    ...
    public class PieceRateImportDiffRateReportDataSet : ReportDataSet<PieceRateImportDiffRateReport>
    {
        ...
        public PieceRateImportDiffRateReportDataSet()
        {
            this.Columns.AddRange(new DataColumn[]{
				Contract,PrdDate,REPrdDate,PrtCode,PrdQuantity,REPrdQuantity,PrdCost,REPrdCost,PrdRdCost,REPrdRdCost,PrtKey,REPrtKey,ContractNo,REContractNo,Errormsg,Totalcost,RETotalcost
				});
        ...
        public PieceRateImportDiffRateReportDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<PieceRateImportDiffRateReport> datas = dataSource as Metex.Core.EntityBindingList<PieceRateImportDiffRateReport>;
        ...
        protected override DataRow ApplyRow(PieceRateImportDiffRateReport data)
        {
