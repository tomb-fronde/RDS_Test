...
namespace NZPostOffice.ODPS.Entity.OdpsRep
{
    ...
    [MapInfoIndex(new string[] { "dtl","c_ird_no","employee_full_name",
    ...
    public class IrdPaydayDetailException : Entity<IrdPaydayDetailException>
    {
        ...
        public static IrdPaydayDetailException NewIrdPaydayDetailException(DateTime? startdate, DateTime? enddate)
        {
            return Create(startdate, enddate);
        }

        public static IrdPaydayDetailException[] GetAllIrdPaydayDetailException(DateTime? startdate, DateTime? enddate)
        {
        ...
        private void FetchEntity(DateTime? startdate, DateTime? enddate)
        {
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
            {
                using (DbCommand cm = cn.CreateCommand())
                {
                    ...
                    List<IrdPaydayDetailException> _list = new List<IrdPaydayDetailException>();
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            IrdPaydayDetailException instance = new IrdPaydayDetailException();
                            ...
                            instance._cs_deductioncode = dr.GetString(11);
