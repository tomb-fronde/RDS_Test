...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    // Get only Activity-based allowance calc Allowance_types
	...
	public class DddwAllowanceTypesActivity : Entity<DddwAllowanceTypesActivity>
	{
		...
		public static DddwAllowanceTypesActivity NewDddwAllowanceTypesActivity(  )
		{
			return Create();
		}

		public static DddwAllowanceTypesActivity[] GetAllDddwAllowanceTypesActivity()
		{
			return Fetch().list;
		}
		#endregion
			...
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
                try
                {
                    using (DbCommand cm = cn.CreateCommand())
                    {
                        ...
                        List<DddwAllowanceTypesActivity> _list = new List<DddwAllowanceTypesActivity>();
                        using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                        {
                            while (dr.Read())
                            {
                                DddwAllowanceTypesActivity instance = new DddwAllowanceTypesActivity();
