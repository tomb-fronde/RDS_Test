...
CREATE procedure [odps].[OD_RPS_Invoice_pay_piecerate_detailcp](
	@invoiceid int,
	@contractno int,
	@contractorno int,
  ...
  if @v_contract_no > 1
    begin
                   ...
                   (select max(cr2.contract_seq_number) 
                     ...
                     where cr2.contract_no = @contractno and
                           ...
                           (contract.con_date_terminated is null 
                             ...
                             or (contract.con_date_terminated - @payperiod_start) < 32 
      ...
      select t_invoice_piecerates2.invoice_id,
             ...
             t_invoice_piecerates2.cost,
             t_invoice_piecerates2.atype
        from t_invoice_piecerates2 
       where t_invoice_piecerates2.invoice_id = @invoiceid and
             t_invoice_piecerates2.prd_date between @v_contractor_start 
                                                and @v_contractor_end 
       order by t_invoice_piecerates2.prd_date asc,
    ...
    select t_invoice_piecerates2.invoice_id,
           ...
           t_invoice_piecerates2.atype
      from t_invoice_piecerates2 
     where t_invoice_piecerates2.invoice_id = @invoiceid 
     order by t_invoice_piecerates2.prd_date asc,
              t_invoice_piecerates2.prt_code asc
end