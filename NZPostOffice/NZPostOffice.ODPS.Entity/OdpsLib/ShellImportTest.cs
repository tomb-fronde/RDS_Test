...
namespace NZPostOffice.ODPS.Entity.OdpsLib
{
    ...
    public class ShellImportTest : Entity<ShellImportTest>
    {
        ...
        public static ShellImportTest NewShellImportTest()
        {
            return Create();
        }

        public static ShellImportTest[] GetAllShellImportTest()
        {
            return Fetch().list;
        }
        #endregion
        ...
        private void FetchEntity()
        {
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
            {
                using (DbCommand cm = cn.CreateCommand())
                {
                    ...
                    List<ShellImportTest> _list = new List<ShellImportTest>();
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            ShellImportTest instance = new ShellImportTest();
                            instance.MarkOld();
