...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
    ...
    // Get only ROI allowance calc Allowance_types
	...
	public class DddwAllowanceTypesROI : Entity<DddwAllowanceTypesROI>
	{
		...
		public static DddwAllowanceTypesROI NewDddwAllowanceTypesROI(  )
		{
			return Create();
		}

		public static DddwAllowanceTypesROI[] GetAllDddwAllowanceTypesROI()
		{
			return Fetch().list;
		}
		#endregion
			...
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
                try
                {
                    using (DbCommand cm = cn.CreateCommand())
                    {
                        ...
                        List<DddwAllowanceTypesROI> _list = new List<DddwAllowanceTypesROI>();
                        using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                        {
                            while (dr.Read())
                            {
                                DddwAllowanceTypesROI instance = new DddwAllowanceTypesROI();
