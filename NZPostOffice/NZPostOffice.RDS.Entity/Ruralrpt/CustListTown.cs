...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class CustListTown : Entity<CustListTown>
	{
		...
		public static CustListTown NewCustListTown(  )
		{
			return Create();
		}

		public static CustListTown[] GetAllCustListTown(  )
		{
			return Fetch().list;
		}
		#endregion
		...
		private void FetchEntity(  )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<CustListTown> _list = new List<CustListTown>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							CustListTown instance = new CustListTown();
