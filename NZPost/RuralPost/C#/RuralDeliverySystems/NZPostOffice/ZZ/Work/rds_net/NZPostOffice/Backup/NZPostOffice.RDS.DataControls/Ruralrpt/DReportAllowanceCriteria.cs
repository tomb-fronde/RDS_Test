...
{
	public partial class DReportAllowanceCriteria : Metex.Windows.DataUserControl
	{
        // TJB  FCR_001 28-Nov-2012
        // Increased size of renewal group dropdown to include November Renewals

		public DReportAllowanceCriteria()
		{
			InitializeComponent();
			InitializeDropdown();
		}
        ...
        {
            return RetrieveCore<ReportAllowanceCriteria>(new List<ReportAllowanceCriteria>(ReportAllowanceCriteria.GetAllReportAllowanceCriteria()));
		}
	}
}
