namespace NZPostOffice.RDSAdmin.DataControls.Security
{
	partial class DFuelType
	{
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDSAdmin.Entity.Security.FuelType);
			...
			this.ft_description.DefaultCellStyle.BackColor = System.Drawing.ColorTranslator.FromWin32(1090519039);
			...
			this.ft_description.HeaderText = "Fuel Types";
			this.ft_description.Name = "ft_description";
			this.ft_description.Width = 180;
