...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
	...
	public class ReportGenericCriteriaWithRegion : Entity<ReportGenericCriteriaWithRegion>
	{
		...
		public static ReportGenericCriteriaWithRegion NewReportGenericCriteriaWithRegion(  )
		{
			return Create();
		}

		public static ReportGenericCriteriaWithRegion[] GetAllReportGenericCriteriaWithRegion(  )
		{
			return Fetch().list;
		}
		#endregion
		...
		private void FetchEntity(  )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<ReportGenericCriteriaWithRegion> _list = new List<ReportGenericCriteriaWithRegion>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							ReportGenericCriteriaWithRegion instance = new ReportGenericCriteriaWithRegion();
