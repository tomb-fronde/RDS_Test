...
namespace NZPostOffice.ODPS.DataControls.Report
{
    ...
    public class PaymentSummaryDataSet : ReportDataSet<PaymentSummary>
    {
        ...
        public PaymentSummaryDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<PaymentSummary> datas = dataSource as Metex.Core.EntityBindingList<PaymentSummary>;
        ...
        protected override DataRow ApplyRow(PaymentSummary data)
        {
