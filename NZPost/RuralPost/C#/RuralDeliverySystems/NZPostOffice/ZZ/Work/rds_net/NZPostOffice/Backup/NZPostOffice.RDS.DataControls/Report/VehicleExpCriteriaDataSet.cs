...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class RVehicleExpCriteria
    {
        public int RegionId
        {
            get
    ...
    public class VehicleExpCriteriaDataSet : ReportDataSet<VehicleExpCriteria>
    {
        ...
        public VehicleExpCriteriaDataSet()
        {
        ...
        public VehicleExpCriteriaDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<VehicleExpCriteria> datas = dataSource as Metex.Core.EntityBindingList<VehicleExpCriteria>;
        ...
        protected override DataRow ApplyRow(VehicleExpCriteria data)
        {
