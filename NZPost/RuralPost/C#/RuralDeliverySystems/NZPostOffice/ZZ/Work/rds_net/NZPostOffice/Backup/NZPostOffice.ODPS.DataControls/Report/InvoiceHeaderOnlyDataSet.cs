...
namespace NZPostOffice.ODPS.DataControls.Report
{
    ...
    public class RInvoiceHeaderOnly
    {
    ...
    public class InvoiceHeaderOnlyDataSet : ReportDataSet<InvoiceHeaderOnly>
    {
        ...
        public InvoiceHeaderOnlyDataSet()
        {
            this.Columns.AddRange(new DataColumn[]{
				ContractStartDate,ContractNo,REContractNo,CGstNumber,ConTitle,CSurnameCompany,CFirstNames,CAddress,CinvoiceNo,PaymentInvoiceId,REPaymentInvoiceId,ContractorContractorSupplierNo,REContractorContractorSupplierNo,Prc,Compute0012,RECompute0012,DsNo,Cinvmessage,Cxpc,Compute4,RECxpc
				});
        ...
        public InvoiceHeaderOnlyDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<InvoiceHeaderOnly> datas = dataSource as Metex.Core.EntityBindingList<InvoiceHeaderOnly>;
        ...
        protected override DataRow ApplyRow(InvoiceHeaderOnly data)
        {
