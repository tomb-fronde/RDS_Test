...
namespace NZPostOffice.ODPS.DataControls.Report
{
    ...
    public class RAuditLogAddresschange
    {
        public int AKey
        {
            get
    ...
    public class AuditLogAddresschangeDataSet : ReportDataSet<AuditLogAddresschange>
    {
        ...
        public AuditLogAddresschangeDataSet()
        {
        ...
        public AuditLogAddresschangeDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<AuditLogAddresschange> datas = dataSource as Metex.Core.EntityBindingList<AuditLogAddresschange>;
        ...
        protected override DataRow ApplyRow(AuditLogAddresschange data)
        {
