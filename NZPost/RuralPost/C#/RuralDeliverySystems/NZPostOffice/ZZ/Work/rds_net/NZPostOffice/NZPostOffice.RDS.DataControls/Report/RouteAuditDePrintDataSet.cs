...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class RouteAuditDePrintDataSet : ReportDataSet<RouteAuditDePrint>
    {
        ...
        public RouteAuditDePrintDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<RouteAuditDePrint> datas = dataSource as Metex.Core.EntityBindingList<RouteAuditDePrint>;
        ...
        protected override DataRow ApplyRow(RouteAuditDePrint data)
        {
