...
namespace NZPostOffice.DataControls
{
	partial class DDddwFilteredRegions
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "DDddwFilteredRegions";
			((System.ComponentModel.ISupportInitialize)(this.bindingSource)).BeginInit();
			this.SuspendLayout();
			this.bindingSource.DataSource = typeof(NZPostOffice.Entity.FilteredRegions);
			//
			// rgn_name
			//
			...
			this.rgn_name.Location = new System.Drawing.Point(3, 1);
			this.rgn_name.MaxLength = 40;
			this.rgn_name.Name = "rgn_name";
			this.rgn_name.Size = new System.Drawing.Size(205, 14);
