...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class RSummaryCustListCustSeq
    {
        public int SeqNum
        {
            get
    ...
    public class SummaryCustListCustSeqDataSet : ReportDataSet<SummaryCustListCustSeq>
    {
        ...
        public SummaryCustListCustSeqDataSet()
        {
        ...
        public SummaryCustListCustSeqDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<SummaryCustListCustSeq> datas = dataSource as Metex.Core.EntityBindingList<SummaryCustListCustSeq>;
        ...
        protected override DataRow ApplyRow(SummaryCustListCustSeq data)
        {
