...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
	...
	public class RouteAuditDePrintBlank : Entity<RouteAuditDePrintBlank>
	{
		...
		public static RouteAuditDePrintBlank NewRouteAuditDePrintBlank( int? contract, DateTime? auditdate )
		{
			return Create(contract, auditdate);
		}

		public static RouteAuditDePrintBlank[] GetAllRouteAuditDePrintBlank( int? contract, DateTime? auditdate )
		{
		...
		private void FetchEntity( int? contract, DateTime? auditdate )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<RouteAuditDePrintBlank> _list = new List<RouteAuditDePrintBlank>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							RouteAuditDePrintBlank instance = new RouteAuditDePrintBlank();
