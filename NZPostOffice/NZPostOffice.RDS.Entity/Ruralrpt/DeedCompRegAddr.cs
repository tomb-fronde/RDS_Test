...
namespace NZPostOffice.RDS.Entity.Ruralrpt
{
    ...
    public class DeedCompRegAddr : Entity<DeedCompRegAddr>
    {
        ...
        //(  six_nat  +  five_nat  +  four_nat  )   /  total_nat
        ...
        //(  six_nat  +  five_nat  +  four_nat  +  three_nat  )   /  total_nat
        ...
        //(  six_nat  +  five_nat  +  four_nat  +  three_nat  +  two_nat  )   /  total_nat
        ...
        //cust_6 + cust_5 + cust_4 + cust_3 + cust_2 + cust_1
        ...
        // needs to implement compute expression manually:
        // compute control name=[cust_sub_5]
        //cust_4 + cust_3 + cust_2 + cust_1
        ...
        //pvt_one + pvt_two + pvt_three + pvt_four
        ...
        //one_nat  +  two_nat  +  three_nat  +  four_nat
        ...
        //  (  one_nat + two_nat + three_nat + four_nat  ) / total_nat  
        public virtual int? Compute9
        {
            get
            {
                CanReadProperty(true);
        ...
        //one_ch  +  two_ch  +  three_ch  +  four_ch
        ...
        //one_dun  +  two_dun  +  three_dun  +  four_dun
        ...
        //one_ham  +  two_ham  +  three_ham  +  four_ham
        ...
        //one_rot  +  two_rot  +  three_rot  +  four_rot
        ...
        public static DeedCompRegAddr NewDeedCompRegAddr()
        {
            return Create();
        }

        public static DeedCompRegAddr[] GetAllDeedCompRegAddr()
        {
            return Fetch().list;
        }
        #endregion
        ...
        private void FetchEntity()
        {
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
            {
                using (DbCommand cm = cn.CreateCommand())
                {
                    ...
                    cm.CommandText = "rd.sp_deed_compliance_addr";
                    ParameterCollection pList = new ParameterCollection();

                    List<DeedCompRegAddr> _list = new List<DeedCompRegAddr>();
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            DeedCompRegAddr instance = new DeedCompRegAddr();
