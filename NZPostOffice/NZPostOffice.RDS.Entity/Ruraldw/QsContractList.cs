...
namespace NZPostOffice.RDS.Entity.Ruraldw
{
	...
	public class QsContractList : Entity<QsContractList>
	{
		...
		public static QsContractList NewQsContractList( int? supplierno, string suppliername )
		{
			return Create(supplierno, suppliername);
		}

		public static QsContractList[] GetAllQsContractList( int? supplierno, string suppliername )
		{
		...
		private void FetchEntity( int? supplierno, string suppliername )
		{
			using ( DbConnection cn= DbConnectionFactory.RequestNextAvaliableSessionDbConnection( "NZPO"))
			{
				using (DbCommand cm = cn.CreateCommand())
				{
					...
					List<QsContractList> _list = new List<QsContractList>();
					using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
					{
						while (dr.Read())
						{
							QsContractList instance = new QsContractList();
