...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class RReportRcmCriteria
    {
        public int RegionId
        {
            get
    ...
    public class ReportRcmCriteriaDataSet : ReportDataSet<ReportRcmCriteria>
    {
        ...
        public ReportRcmCriteriaDataSet()
        {
        ...
        public ReportRcmCriteriaDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<ReportRcmCriteria> datas = dataSource as Metex.Core.EntityBindingList<ReportRcmCriteria>;
        ...
        protected override DataRow ApplyRow(ReportRcmCriteria data)
        {
