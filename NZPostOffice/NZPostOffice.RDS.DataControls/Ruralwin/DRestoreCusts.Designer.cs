namespace NZPostOffice.RDS.DataControls.Ruralwin
{
	partial class DRestoreCusts
	{
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDS.Entity.Ruralwin.RestoreCusts);
            ...
            this.moveoutdate.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
