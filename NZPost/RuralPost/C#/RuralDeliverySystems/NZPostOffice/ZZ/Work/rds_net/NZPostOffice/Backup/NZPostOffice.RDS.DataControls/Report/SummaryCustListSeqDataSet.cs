...
namespace NZPostOffice.RDS.DataControls.Report
{
    ...
    public class RSummaryCustListSeq
    {
        public int SeqNum
        {
            get
    ...
    public class SummaryCustListSeqDataSet : ReportDataSet<SummaryCustListSeq>
    {
        ...
        public SummaryCustListSeqDataSet()
        {
        ...
        public SummaryCustListSeqDataSet(object dataSource)
            : this()
        {
            Metex.Core.EntityBindingList<SummaryCustListSeq> datas = dataSource as Metex.Core.EntityBindingList<SummaryCustListSeq>;
        ...
        protected override DataRow ApplyRow(SummaryCustListSeq data)
        {
