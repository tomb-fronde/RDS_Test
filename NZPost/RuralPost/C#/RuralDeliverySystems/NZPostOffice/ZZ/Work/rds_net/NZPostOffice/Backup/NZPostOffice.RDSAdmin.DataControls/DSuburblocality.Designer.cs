namespace NZPostOffice.RDSAdmin.DataControls.Security
{
	partial class DSuburblocality
	{
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDSAdmin.Entity.Security.Suburblocality);
            ...
            this.sl_name.DefaultCellStyle.BackColor = System.Drawing.Color.White;
			...
			this.sl_name.HeaderText = "Suburb / Locality Name";
			this.sl_name.Name = "sl_name";
			this.sl_name.Width = 350;
