...
namespace NZPostOffice.RDS.DataControls.Ruralsec
{
	partial class DUserTest
	{
		...
		private void InitializeComponent()
		{
			...
			this.SuspendLayout();
			this.bindingSource.DataSource = typeof(NZPostOffice.RDS.Entity.Ruralsec.UserTest);
			//
			// rds_user_u_id_t
			//
			...
			this.rds_user_u_id_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_u_name_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_u_location_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_u_phone_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_u_mobile_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_region_id_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.region_rgn_name_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_userid_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_password_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_last_login_date_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_last_login_time_t.TextAlign =ContentAlignment.MiddleLeft;
            ...
            this.rds_user_id_ui_last_login_time.DataBindings[0].FormatString = "hh:mm:ss";
			...
			this.rds_user_id_ui_created_date_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_created_by_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_modified_date_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_modified_by_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_password_expiry_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_grace_logins_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_locked_date_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_can_change_password_t.TextAlign =ContentAlignment.MiddleLeft;
			...
			this.rds_user_id_ui_id_t.TextAlign =ContentAlignment.MiddleLeft;
