namespace NZPostOffice.RDS.DataControls.Ruralsec
{
	partial class DComponentlist
	{
		...
		private void InitializeComponent()
		{
			...
			// bindingSource
			//
			this.bindingSource.DataSource = typeof(NZPostOffice.RDS.Entity.Ruralsec.Componentlist);
			...
			this.description.HeaderText = "Rc Description";
			this.description.Name = "description";
			this.description.Width = 864;
