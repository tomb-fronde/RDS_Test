...
namespace NZPostOffice.ODPS.Entity.OdpsRep
{
    ...
    public class Netpayvariance : Entity<Netpayvariance>
    {
        ...
        public static Netpayvariance NewNetpayvariance(DateTime? sdate, DateTime? edate, DateTime? prevsdate, DateTime? prevedate)
        {
            return Create(sdate, edate, prevsdate, prevedate);
        }

        public static Netpayvariance[] GetAllNetpayvariance(DateTime? sdate, DateTime? edate, DateTime? prevsdate, DateTime? prevedate)
        {
        ...
        private void FetchEntity(DateTime? sdate, DateTime? edate, DateTime? prevsdate, DateTime? prevedate)
        {
            using (DbConnection cn = DbConnectionFactory.RequestNextAvaliableSessionDbConnection("NZPO"))
            {
                using (DbCommand cm = cn.CreateCommand())
                {
                    ...
                    cm.CommandText = "odps.od_rps_netpayvariance";
                    ...
                    List<Netpayvariance> _list = new List<Netpayvariance>();
                    using (MDbDataReader dr = DBHelper.ExecuteReader(cm, pList))
                    {
                        while (dr.Read())
                        {
                            Netpayvariance instance = new Netpayvariance();
                            ...
                            instance._wrate = GetValueFromReader<Int32?>(dr, 6);
                            instance.MarkOld();
